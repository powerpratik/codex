...
def main():
    ...
    # summary
    print("\nBenchmark results:")
    print(f"{'Strategy':<20} {'Time(s)':<12} {'Perplexity':<12} {'Avg KV elems':<12}")
    for r in results:
        print(f"{r['strategy']:<20} {r['avg_time_per_token_s']:<12.4f} {r['perplexity']:<12.2f} {r['avg_kv_elements']:<12.0f}")
